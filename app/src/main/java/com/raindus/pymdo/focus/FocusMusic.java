...
public class FocusMusic {

    private static final String[] MUSIC_PATH = {"focus_forest.mp3", "focus_love.mp3", "focus_positive.mp3"};
    ...
    public FocusMusic(Context context) {
        mContext = context;
    ...
    private void initRingtone() {
        Uri uri = Uri.parse("android.resource://" + mContext.getPackageName() + "/" + R.raw.focus_complete);
