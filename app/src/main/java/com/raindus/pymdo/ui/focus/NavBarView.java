...
public class NavBarView extends View {
    ...
    public FocusLayer.OnLayerScrolledListener mOnLayerScrolledListener = new FocusLayer.OnLayerScrolledListener() {
        @Override
    ...
    public FocusLayer.OnLayerStaticListener mOnLayerStaticListener = new FocusLayer.OnLayerStaticListener() {
        @Override
