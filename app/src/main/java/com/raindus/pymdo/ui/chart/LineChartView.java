...
public class LineChartView extends View {
    ...
    private void initPaint() {
        mPointRadius = Utils.dipToPx(2.5f);
        mValueBaseLine = Utils.dipToPx(6f);

        mPaint = new Paint();
        mPaint.setAntiAlias(true);
        // 连线宽度
        mPaint.setStrokeWidth(Utils.dipToPx(0.8f));
        ...
        mKeyPaint.setTextSize(Utils.dipToPx(12f));
        mKeyPaint.setColor(getResources().getColor(R.color.text_color));

        mValuePaint = new Paint();
        mValuePaint.setAntiAlias(true);
        mValuePaint.setTextAlign(Paint.Align.CENTER);
        mValuePaint.setTextSize(Utils.dipToPx(12f));
