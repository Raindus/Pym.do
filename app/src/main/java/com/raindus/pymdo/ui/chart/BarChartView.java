package com.raindus.pymdo.ui.chart;
...
public class BarChartView extends View {
    ...
    private void initPaint() {
        mBarRoundRadius = Utils.dipToPx(12f);
        ...
        mFootTextPaint.setColor(getResources().getColor(R.color.text_color));
    ...
    private void initSize() {
        ...
        if (mCurMode == MODE_WEEK) {
            ...
            mHalfOfWidth = Utils.dipToPx(3.3f);
    ...
    private void drawWeek(Canvas canvas) {
        ...
        mFootTextPaint.setTextSize(Utils.dipToPx(16f));
    ...
    private void drawTime(Canvas canvas) {
        ...
        mFootTextPaint.setTextSize(Utils.dipToPx(12f));
        for (int i : TEXT_TIME) {
